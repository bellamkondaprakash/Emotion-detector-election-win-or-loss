...
class TwitterClient(object):
	...
	def __init__(self):
		...
		consumer_key = 'rRU2XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX0Ks'
		consumer_secret = '3TMXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXAROZhJ9'
		access_token = '82XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX3WqYZ'
		access_token_secret = 'ZBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXP4VZskOy'
...
def main():
	...
	tweets = api.get_tweets(query = '#SP', count = 200)
